...
public class Sequence {
	...
	//@see README.md
	private static String generateId(String workerId) {
        return GenerateIdsUtil.generateId(workerId);
	}
	...
	public static String generateOcrId() {
		return createId();
	}
	...
	public static String generateMemberId() {//3
		return createId();
	}
	...
	public static String generateAccountId() {//7
		return createId();
	}
